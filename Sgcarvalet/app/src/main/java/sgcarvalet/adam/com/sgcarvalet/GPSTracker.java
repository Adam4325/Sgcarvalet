...
// if GPS Enabled get lat/long using GPS Services
    ...
    private void openSettingLocation() {
        new AlertDialog.Builder(this)
                ...
                .setMessage("Silahkan aktifkan/enable setting location GPS anda!?")
                .setPositiveButton("Yes", new DialogInterface.OnClickListener()
                {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        startActivity(new Intent(Settings.ACTION_LOCATION_SOURCE_SETTINGS));
                        //ActivityCompat.startActivityForResult(GPSTracker.this,new Intent(android.provider.Settings.ACTION_SETTINGS), 0);
